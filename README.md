...
1. Tải binary phù hợp từ [GitHub Releases](https://github.com/your-username/monsterinc/releases)
2. Giải nén và đặt trong system PATH
...
- Tạo [GitHub Issue](https://github.com/aleister1102/monsterinc/issues) để báo bug hoặc đề xuất tính năng
- Xem [Wiki](./WIKI.md) để biết thêm chi tiết về cấu trúc và hoạt động của project 