...
// ConfigConverter converts FileLogConfig to LoggerConfig
...
// ConvertFileConfig converts application config to logger config
func (cc *ConfigConverter) ConvertFileConfig(cfg FileLogConfig) (LoggerConfig, error) {
