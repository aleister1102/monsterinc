...
func New(cfg FileLogConfig) (zerolog.Logger, error) {
	logger, err := NewLoggerBuilder().WithFileConfig(cfg).Build()
	if err != nil {
...
func NewWithScanID(cfg FileLogConfig, scanID string) (zerolog.Logger, error) {
...
func NewWithCycleID(cfg FileLogConfig, cycleID string) (zerolog.Logger, error) {
	logger, err := NewLoggerBuilder().
		WithFileConfig(cfg).
		WithCycleID(cycleID).
		Build()
...
func NewWithContext(cfg FileLogConfig, scanID, cycleID string) (zerolog.Logger, error) {
